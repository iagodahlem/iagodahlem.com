...
export const PAGE_DESCRIPTIONS = {
  home: "Personal site of Iago Dahlem, a software engineer from Florianópolis, Brazil, building products end to end — most recently at Clerk, now open to new roles.",
  about:
